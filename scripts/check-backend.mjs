...
const files = ['test/backend-contract.test.js', 'test/probe.test.js', 'test/fake-zcode.cjs', 'test/local-error.test.js', 'test/cli-setup.test.js']
for (const dir of ['src/backend', 'spikes/backend-contract', 'scripts']) {
