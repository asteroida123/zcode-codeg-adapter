...
const cases = [
  ...
  { name: 'runtime model pass-through', file: 'backend.mjs', testFile: 'test/resume-readiness.test.js',
    pattern: 'Resume: continued send passes only an explicit well-formed runtimeModel reference',
    before: 'params.runtimeModel = { providerId: runtimeModel.providerId, modelId: runtimeModel.modelId }',
